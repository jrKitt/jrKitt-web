...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#about" className="flex items-center gap-2 text-gray-600 hover:text-blue-600 transition-all duration-200 text-sm font-medium">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person" viewBox="0 0 16 16">
                  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4Zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10Z"/>
                </svg>
                About
              </a>
              <a href="#projects" className="flex items-center gap-2 text-gray-600 hover:text-blue-600 transition-all duration-200 text-sm font-medium">
              ...
              <a href="#blog" className="flex items-center gap-2 text-gray-600 hover:text-blue-600 transition-all duration-200 text-sm font-medium">
              ...
              <a href="#contact" className="flex items-center gap-2 text-gray-600 hover:text-blue-600 transition-all duration-200 text-sm font-medium">
            ...
            >
              <div className="w-6 h-6 flex flex-col justify-center space-y-1">
                <span className={`block h-0.5 bg-gray-600 rounded transition-all duration-300 ${isMenuOpen ? 'rotate-45 translate-y-1.5' : ''}`}></span>
                <span className={`block h-0.5 bg-gray-600 rounded transition-all duration-300 ${isMenuOpen ? 'opacity-0' : ''}`}></span>
                <span className={`block h-0.5 bg-gray-600 rounded transition-all duration-300 ${isMenuOpen ? '-rotate-45 -translate-y-1.5' : ''}`}></span>
              </div>
            </button>
          </div>
      ...
      <section id="about" className="pt-32 pb-20 px-6 bg-gradient-to-br from-slate-900 via-blue-900 to-navy-900">
          ...
          <div className="mb-12 flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 space-y-8">
              <div className="space-y-6">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-blue-300 font-medium">@jrKitt • Full Stack Developer</div>
                  </div>
                </div>
                ...
                <p className="text-xl text-blue-100 leading-relaxed max-w-2xl">
                  Junior Full Stack Developer at <span className="font-semibold text-blue-300">APSTH</span> & 
                  Web Developer at <span className="font-semibold text-blue-200">Student Union KKU</span>. 
                  Passionate about building accessible, user-friendly applications with modern web technologies.
                </p>
                
                <div className="flex items-center gap-4 text-sm text-blue-200">
                  <div className="flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-geo-alt text-blue-300" viewBox="0 0 16 16">
              ...
              <div className="flex flex-wrap gap-4">
                <a href="mailto:contact@jrkitt.dev" 
                ...
                <a href="https://github.com/jrKitt" target="_blank" rel="noopener noreferrer"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">Contributions this year</div>
            </div>
            <div className="text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group p-6 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl hover:shadow-lg transition-all duration-300 border border-blue-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2 bg-blue-500 rounded-lg">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" className="bi bi-display" viewBox="0 0 16 16">
            ...
            <div className="group p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl hover:shadow-lg transition-all duration-300 border border-green-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2 bg-green-500 rounded-lg">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" className="bi bi-server" viewBox="0 0 16 16">
            ...
            <div className="group p-6 bg-gradient-to-br from-purple-50 to-violet-50 rounded-2xl hover:shadow-lg transition-all duration-300 border border-purple-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2 bg-purple-500 rounded-lg">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" className="bi bi-database" viewBox="0 0 16 16">
                ...
                <h4 className="text-lg font-semibold text-gray-800">Database</h4>
              </div>
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-gray-700">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
            ...
            <div className="group p-6 bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl hover:shadow-lg transition-all duration-300 border border-orange-100">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="text-lg font-semibold text-gray-800">Tools & Cloud</h4>
              </div>
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-gray-700">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              ...
              <div key={project.id} className="project-card">
                <div className="aspect-video rounded-lg mb-4 relative overflow-hidden">
                  {project.image ? (
                    ...
                    <div className={`bg-gradient-to-br ${project.gradient} flex items-center justify-center relative h-full`}>
                      <div className="absolute inset-0 bg-black/20"></div>
                      <div className="relative z-10 text-center text-white">
                        <div className="text-4xl mb-2">{project.fallbackIcon}</div>
                        <div className="text-sm font-medium">{project.subtitle}</div>
                        <div className="text-xs opacity-80">{project.title}</div>
                      </div>
                    </div>
                  )}
                  <div className={`absolute top-2 right-2 ${project.badge.color} ${project.badge.textColor || 'text-white'} text-xs px-2 py-1 rounded-full`}>
                    {project.badge.text}
                  </div>
                </div>
          ...
          <ul className="space-y-8">
            <li>
              <article className="group cursor-pointer">
                <a href="/blog/smocp-3-days" className="block hover:bg-gray-50 -mx-4 px-4 py-4 rounded-lg transition-colors duration-200">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 mb-3 leading-relaxed">
                        ตอนแรกกะจะไม่ได้ทำ แต่พอเห็นพี่ๆในห้องนั่งวาด Flow กันก็สนใจ เลยได้โอกาสเข้าร่วมทำเว็บ e-commerce สำหรับสโม วิทยาลัยคอมพิวเตอร์ภายใน 3 วัน พร้อมเรียนรู้เครื่องมือใหม่ๆ อย่าง Google Script...
                      </p>
                      <div className="flex items-center gap-4 text-sm text-gray-500">
                        ...
                        <span>•</span>
                        <span className="text-blue-600">Express.js, Bootstrap, Google Script</span>
                      </div>
                    </div>
                    <div className="text-gray-400 group-hover:text-blue-600 transition-colors duration-200">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-arrow-right" viewBox="0 0 16 16">
                        <path fillRule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L12.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
                      </svg>
                    </div>
                  </div>
                </a>
      ...
      <section id="contact" className="py-16 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-8">
            ...
            <a href="https://www.linkedin.com/in/jrKitt" target="_blank" rel="noopener noreferrer" 
               className="contact-link-secondary flex items-center gap-2">
